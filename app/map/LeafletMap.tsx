...
import { Input, Box, InputRightElement, InputGroup, Button } from "@chakra-ui/react";
      ...
      >
        ...
        >
          ...
          <InputRightElement width="5rem">
            <Button h="1.75rem" size="sm" onClick={onSearchAdress} isLoading={isLoadingCoords}>
              Search
            </Button>
          </InputRightElement>
        </InputGroup>
